...
left: -10px;
margin: 10px auto; 
    width:600px; /* Change this to your images width  was 480*/
...
div#fbcaption.nivo-html-caption div.nivo-caption1a img {
	position:relative;
}*/
...
<!-- Shine.io-->
									<div id="page-home" class="home-frame"> 
											...
											<div id="fbcaption" class="nivo-html-caption">
																																  <p><center>  <strong>Fort Bliss</strong></center></p>
   <p><center> text text text text text text text text text</center></p>                                                                                                                               
  <div class="nivo-caption1a"><img src="/images/red_laurelleaf.png" align="left" style="display:inline; position:relative; height: 98px;" alt="" title="" rel="/images/red_laurelleaf.png"/></div>
