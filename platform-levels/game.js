...
window.addEventListener('touchstart', function(){
	if(!IS_TOUCH){
		IS_TOUCH = true;
		console.log("touch start is true");
...
class GameJS extends Phaser.Scene{
	...
	//set camera size from the level file
		...
		if(IS_TOUCH){
			...
			let exitFullScreen = this.add.rectangle(this.game.canvas.width - 225, 75, 200, 100, 0xfa3628, 0.8);
